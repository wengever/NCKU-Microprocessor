...
DELAYCheckButton_1 macro num1, num2
    local LOOP1         ; Inner loop
    local LOOP2         ; Outer loop
    ...
    BRA lightup2_1     ; If button is pressed, branch to State2
...
DELAYCheckButton_2 macro num1, num2
    local LOOP1         ; Inner loop
    local LOOP2         ; Outer loop
    ...
    BTFSS PORTB, 0      ; Check if PORTB bit 0 is low (button pressed)
    BRA State0      ; If button is pressed, branch to State2
...
CheckO:
    ...
    BRA lightup1_1    ; If button is pressed, branch to lightup

lightup1_1:
    BCF LATA, 2
    BSF LATA, 0
    DELAY d'111', d'70' ; Call delay macro to delay for about 0.25 seconds  need to delay press button
    DELAYCheckButton_1 d'111', d'70' ; Call delay macro to delay for about 0.25 seconds
    GOTO lightup1_2
...
lightup2_1:
    ...
    BCF LATA, 2
    DELAY d'111', d'70' ; Call delay macro to delay for about 0.25 seconds  need to delay press button
    DELAYCheckButton_2 d'111', d'70' ; Call delay macro to delay for about 0.25 seconds
    DELAYCheckButton_2 d'111', d'70' ; Call delay macro to delay for about 0.25 seconds
    DELAYCheckButton_2 d'111', d'70' ; Call delay macro to delay for about 0.25 seconds
    GOTO lightup2_2
